package by.it.group410901.matveev.lesson12;
...
public class MyRbMap implements SortedMap<Integer, String> {
    ...
    private static class Node {
        ...
        Node left, right;
        boolean color;
        Node(int k, String v, boolean c) { key = k; val = v; color = c; }
    }
    ...
    private Node deleteMin(Node h) {
        if (h.left == null) { removedFlag = true; return null; }
    ...
    private Node deleteRec(Node h, int key) {
        ...
        if (key < h.key) {
            ...
            if (key == h.key && h.right == null) { removedFlag = true; return null; }
            if (h.right != null) {
